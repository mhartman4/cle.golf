...
schedule = [
  ...
  {name: 'Sanderson Farms Championship', date: new Date(Date.parse('9-19-2019')), tournament_id: '54'},
  {name: 'Safeway Open', date: new Date(Date.parse('9-26-2019')), tournament_id: '464'},
  {name: 'Shriners Hospitals for Children Open', date: new Date(Date.parse('10-3-2019')), tournament_id: '47'},
  {name: 'Houston Open', date: new Date(Date.parse('10-10-2019')), tournament_id: '20'},
  ...
  {name: 'QBE Shootout', date: new Date(Date.parse('12-13-2019')), tournament_id: '58'},
  {name: 'Sentry Tournament of Champions', date: new Date(Date.parse('1-2-2020')), tournament_id: '16'},
  {name: 'Sony Open in Hawaii', date: new Date(Date.parse('1-9-2020')), tournament_id: '6'},
  {name: 'The American Express', date: new Date(Date.parse('1-16-2020')), tournament_id: '2'},
  {name: 'Farmers Insurance Open', date: new Date(Date.parse('1-23-2020')), tournament_id: '4'},
  {name: 'Waste Management Phoenix Open', date: new Date(Date.parse('1-30-2020')), tournament_id: '3'},
  {name: 'AT&T Pebble Beach Pro-Am', date: new Date(Date.parse('2-6-2020')), tournament_id: '5'},
  {name: 'The Genesis Invitational', date: new Date(Date.parse('2-13-2020')), tournament_id: '7'},
  ...
  {name: 'The Honda Classic', date: new Date(Date.parse('2-27-2020')), tournament_id: '10'},
  {name: 'Arnold Palmer Invitational presented by Mastercard', date: new Date(Date.parse('3-5-2020')), tournament_id: '9'},
  {name: 'THE PLAYERS Championship', date: new Date(Date.parse('3-12-2020')), tournament_id: '11'},
  ...
  {name: 'Valero Texas Open', date: new Date(Date.parse('4-2-2020')), tournament_id: '41'},
  {name: 'Masters Tournament', date: new Date(Date.parse('4-9-2020')), tournament_id: '14'},
  {name: 'RBC Heritage', date: new Date(Date.parse('4-16-2020')), tournament_id: '12'},
  {name: 'Zurich Classic of New Orleans', date: new Date(Date.parse('4-23-2020')), tournament_id: '18'},
  {name: 'Wells Fargo Championship', date: new Date(Date.parse('4-30-2020')), tournament_id: '480'},
  {name: 'AT&T Byron Nelson', date: new Date(Date.parse('5-7-2020')), tournament_id: '19'},
  {name: 'PGA Championship', date: new Date(Date.parse('5-14-2020')), tournament_id: '33'},
  {name: 'Charles Schwab Challenge', date: new Date(Date.parse('5-21-2020')), tournament_id: '21'},
  {name: 'Rocket Mortgage Classic', date: new Date(Date.parse('5-28-2020')), tournament_id: '524'},
  {name: 'the Memorial Tournament presented by Nationwide', date: new Date(Date.parse('6-4-2020')), tournament_id: '23'},
  {name: 'RBC Canadian Open', date: new Date(Date.parse('6-11-2020')), tournament_id: '32'},
  {name: 'U.S. Open', date: new Date(Date.parse('6-18-2020')), tournament_id: '26'},
  {name: 'Travelers Championship', date: new Date(Date.parse('6-25-2020')), tournament_id: '34'},
  ...
  {name: 'John Deere Classic', date: new Date(Date.parse('7-9-2020')), tournament_id: '30'},
  ...
  {name: 'Wyndham Championship', date: new Date(Date.parse('8-6-2020')), tournament_id: '13'},
  {name: 'THE NORTHERN TRUST', date: new Date(Date.parse('8-13-2020')), tournament_id: '27'},
  {name: 'BMW Championship', date: new Date(Date.parse('8-20-2020')), tournament_id: '28'},
  {name: 'TOUR Championship', date: new Date(Date.parse('8-27-2020')), tournament_id: '60'},
...
teams = {
  "Smails` Paralegals (Tink #1)": [{name: "Rory McIlroy", id: "28237"},{name: "Sungjae Im", id: "39971"},{name: "Matthew Fitzpatrick", id: "40098"},{name: "Viktor Hovland", id: "46717"},{name: "Joaquin Niemann", id: "45486"},{name: "Kristoffer Ventura", id: "35658"},{name: "Matt Wallace", id: "48887"},{name: "Lucas Bjerregaard", id: "33803"}],
  "Josh Maus #2 (Tink #2)": [{name: "Xander Schauffele", id: "48081"},{name: "Patrick Cantlay", id: "35450"},{name: "Matthew Wolff", id: "56278"},{name: "Scottie Scheffler", id: "46046"},{name: "Eddie Pepperell", id: "34709"},{name: "Maverick McNealy", id: "46442"},{name: "Matt Wallace", id: "48887"},{name: "Bernd Wiesberger", id: "29454"}],
  ...
  "Figs Newtons": [{name: "Rory McIlroy", id: "28237"},{name: "Cameron Champ", id: "52372"},{name: "Sungjae Im", id: "39971"},{name: "Viktor Hovland", id: "46717"},{name: "Kiradech Aphibarnrat", id: "30978"},{name: "Beau Hossler", id: "35461"},{name: "Sam Ryder", id: "37275"},{name: "Matt Wallace", id: "48887"}],
  ...
  "Mulligan Please (Alvin Gentry)": [{name: "Brooks Koepka", id: "36689"},{name: "Emiliano Grillo", id: "31646"},{name: "Rory Sabbatini", id: "23621"},{name: "Matthew Fitzpatrick", id: "40098"},{name: "Camilo Villegas", id: "27770"},{name: "Bernd Wiesberger", id: "29454"},{name: "D.A. Points", id: "25240"},{name: "Ángel Cabrera", id: "20848"}],
  ...
  "Team Wally": [{name: "Jason Kokrak", id: "30944"},{name: "Viktor Hovland", id: "46717"},{name: "Bryson DeChambeau", id: "47959"},{name: "Sungjae Im", id: "39971"},{name: "Matthew Wolff", id: "56278"},{name: "Sepp Straka", id: "49960"},{name: "Tom Hoge", id: "35532"},{name: "Fabian Gomez", id: "28679"}],
  "Ty Webb`s Blindfolded (Trey)": [{name: "Gary Woodland", id: "31323"},{name: "Sung Kang", id: "27974"},{name: "J.T. Poston", id: "49771"},{name: "Kevin Streelman", id: "27214"},{name: "Cameron Champ", id: "52372"},{name: "Chris Stroud", id: "27963"},{name: "Adam Schenk", id: "47347"},{name: "Roberto Castro", id: "32200"}],
  ...
  "JJ Polk": [{name: "Adam Scott", id: "24502"},{name: "Tommy Fleetwood", id: "30911"},{name: "J.B. Holmes", id: "27141"},{name: "Jimmy Walker", id: "25632"},{name: "Andrew Landry", id: "33410"},{name: "Jonas Blixt", id: "27895"},{name: "Luke Donald", id: "23983"},{name: "Robert Garrigus", id: "24358"}],
  ...
  "Emotional Rescue (Dr. Pandya)": [{name: "Rory McIlroy", id: "28237"},{name: "Billy Horschel", id: "29420"},{name: "Viktor Hovland", id: "46717"},{name: "Tom Hoge", id: "35532"},{name: "Xinjun Zhang", id: "32254"},{name: "Tom Lewis", id: "35104"},{name: "Kristoffer Ventura", id: "35658"},{name: "Maverick McNealy", id: "46442"}],
  ...
  "Windler #1": [{name: "Tony Finau", id: "29725"},{name: "Joaquin Niemann", id: "45486"},{name: "Sungjae Im", id: "39971"},{name: "Viktor Hovland", id: "46717"},{name: "Matthew Fitzpatrick", id: "40098"},{name: "Danny Willett", id: "32139"},{name: "Scottie Scheffler", id: "46046"},{name: "Doug Ghim", id: "52375"}],
  "Windler #2": [{name: "Keith Mitchell", id: "39546"},{name: "Collin Morikawa", id: "50525"},{name: "Lucas Glover", id: "25900"},{name: "Sungjae Im", id: "39971"},{name: "Viktor Hovland", id: "46717"},{name: "Scottie Scheffler", id: "46046"},{name: "Corey Conners", id: "39997"},{name: "Joaquin Niemann", id: "45486"}],
  ...
  "Shane Kupperman": [{name: "Patrick Cantlay", id: "35450"},{name: "Sungjae Im", id: "39971"},{name: "Jason Kokrak", id: "30944"},{name: "Joaquin Niemann", id: "45486"},{name: "Anirban Lahiri", id: "31420"},{name: "Beau Hossler", id: "35461"},{name: "Erik van Rooyen", id: "40006"},{name: "Sam Burns", id: "47504"}],
