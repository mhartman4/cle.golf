...
schedule = [
  ...
  { name: 'Hero World Challenge ', date: new Date(Date.parse('2020-12-03')), tournament_id: '478'},
  { name: 'Mayakoba Golf Classic', date: new Date(Date.parse('2020-12-03')), tournament_id: '457'},
  { name: 'Sentry Tournament of Champions ', date: new Date(Date.parse('2021-01-07')), tournament_id: '016'},
  { name: 'Sony Open in Hawaii', date: new Date(Date.parse('2021-01-14')), tournament_id: '006'},
  { name: 'The American Express ', date: new Date(Date.parse('2021-01-21')), tournament_id: '002'},
  { name: 'Farmers Insurance Open ', date: new Date(Date.parse('2021-01-28')), tournament_id: '004'},
  { name: 'Waste Management Phoenix Open', date: new Date(Date.parse('2021-02-04')), tournament_id: '003'},
  { name: 'AT&T Pebble Beach Pro-Am ', date: new Date(Date.parse('2021-02-11')), tournament_id: '005'},
  { name: 'The Genesis Invitational ', date: new Date(Date.parse('2021-02-18')), tournament_id: '007'},
  { name: 'World Golf Championships-Mexico Championship ', date: new Date(Date.parse('2021-02-25')), tournament_id: '473'},
  { name: 'Arnold Palmer Invitational presented by Mastercard ', date: new Date(Date.parse('2021-03-04')), tournament_id: '009'},
  { name: 'THE PLAYERS Championship ', date: new Date(Date.parse('2021-03-11')), tournament_id: '011'},
  { name: 'The Honda Classic', date: new Date(Date.parse('2021-03-18')), tournament_id: '010'},
  { name: 'World Golf Championships-Dell Technologies Match Play', date: new Date(Date.parse('2021-03-24')), tournament_id: '470'},
  { name: 'Valero Texas Open', date: new Date(Date.parse('2021-04-01')), tournament_id: '041'},
  { name: 'Masters Tournament ', date: new Date(Date.parse('2021-04-08')), tournament_id: '536'},
  { name: 'RBC Heritage ', date: new Date(Date.parse('2021-04-15')), tournament_id: '012'},
  { name: 'Zurich Classic of New Orleans', date: new Date(Date.parse('2021-04-22')), tournament_id: '018'},
  { name: 'Valspar Championship ', date: new Date(Date.parse('2021-04-29')), tournament_id: '475'},
  { name: 'Wells Fargo Championship ', date: new Date(Date.parse('2021-05-06')), tournament_id: '480'},
  { name: 'AT&T Byron Nelson', date: new Date(Date.parse('2021-05-13')), tournament_id: '019'},
  { name: 'PGA Championship ', date: new Date(Date.parse('2021-05-20')), tournament_id: '033'},
  { name: 'Charles Schwab Challenge ', date: new Date(Date.parse('2021-05-27')), tournament_id: '021'},
  { name: 'the Memorial Tournament presented by Nationwide', date: new Date(Date.parse('2021-06-03')), tournament_id: '023'},
  { name: 'RBC Canadian Open', date: new Date(Date.parse('2021-06-10')), tournament_id: '032'},
  { name: 'U.S. Open', date: new Date(Date.parse('2021-06-17')), tournament_id: '535'},
  { name: 'Travelers Championship ', date: new Date(Date.parse('2021-06-24')), tournament_id: '034'},
  { name: 'Rocket Mortgage Classic', date: new Date(Date.parse('2021-07-01')), tournament_id: '524'},
  { name: 'John Deere Classic ', date: new Date(Date.parse('2021-07-08')), tournament_id: '030'},
  { name: 'The Open Championship', date: new Date(Date.parse('2021-07-15')), tournament_id: '100'},
  { name: '3M Open', date: new Date(Date.parse('2021-07-22')), tournament_id: '525'},
  { name: 'World Golf Championships-FedEx St. Jude Invitational ', date: new Date(Date.parse('2021-08-05')), tournament_id: '476'},
  { name: 'Wyndham Championship ', date: new Date(Date.parse('2021-08-12')), tournament_id: '013'},
  { name: 'THE NORTHERN TRUST ', date: new Date(Date.parse('2021-08-19')), tournament_id: '027'},
  { name: 'BMW Championship ', date: new Date(Date.parse('2021-08-26')), tournament_id: '028'},
  { name: 'TOUR Championship', date: new Date(Date.parse('2021-09-02')), tournament_id: '060'},
  { name: 'RBC Canadian Open', date: new Date(Date.parse('2021-06-10')), tournament_id: '032'},
  { name: 'U.S. Open', date: new Date(Date.parse('2021-06-17')), tournament_id: '535'},
  { name: 'Travelers Championship ', date: new Date(Date.parse('2021-06-24')), tournament_id: '034'},
  { name: 'Rocket Mortgage Classic', date: new Date(Date.parse('2021-07-01')), tournament_id: '524'},
...
function checkForData() {
  ...
  $.getJSON("https://statdata.pgatour.com/r/" + relevantTourney.tournament_id + "/2021/leaderboard-v2.json" + window.securityBlurb, function( data ) {
